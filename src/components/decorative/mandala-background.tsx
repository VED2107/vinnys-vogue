...
/**
 * MandalaBackground — Large, clearly visible gold mandala.
 * Animated fade-in + slow rotation via Framer Motion.
 * ~12–15% opacity, 1.2px strokes, 800–900px scale.
...
export function MandalaBackground({
  ...
  // Keep 60% of the SVG visible — don't push it too far offscreen
